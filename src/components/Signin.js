...
class Signin extends Component {
  ...
  onChange = e => {
    if (e.target.name === "signin-email")
      this.setState({ signEmail: e.target.value });
    if (e.target.name === "signin-password")
      this.setState({ signPassword: e.target.value });
    if (e.target.name === "first-name")
      this.setState({ firstName: e.target.value });
    if (e.target.name === "last-name")
      this.setState({ lastName: e.target.value });
    if (e.target.name === "sign-up-email")
      this.setState({ email: e.target.value });
    if (e.target.name === "sign-up-password")
      this.setState({ password: e.target.value });
    if (e.target.name === "sign-up-rePassword")
          ...
          <div className="Search-signin Search-flex-item">
            ...
            <form onSubmit={this.onFormSubmit}>
              ...
              <input
                ...
                value="Login"
              />
              <a className="Search-a" href="/account/signin">
                Lost your password?
              </a>
              <a className="Search-a" href="/account/signin">
                Forgot email?
